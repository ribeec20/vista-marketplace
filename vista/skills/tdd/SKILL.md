---
name: tdd
description: Generate TDD diagrams for heavy-logic components. Produces logic flows, decision trees, and test contracts as Mermaid diagrams.
...
New files added to `.vista/features/<name>/arch/`:
```
arch/
...
Updated: `.vista/features/<name>/domain-requirements.md` (Test Expectations section appended)
