...
> For strict rules, pitfalls, and advanced patterns for complex Mermaid types (C4, Sequence, State, Class, ER, Gantt), see [mermaid-advanced.md](mermaid-advanced.md).
