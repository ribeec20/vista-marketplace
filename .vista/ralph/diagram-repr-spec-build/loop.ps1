...
$FeatureDir = "C:\Users\Grove\OneDrive\Documents\PYTHON\claude_plugins\vista-expanded-visualization\.vista\ralph\diagram-repr-spec-build"
...
Write-Host "Feature:  diagram-repr-spec-build"
