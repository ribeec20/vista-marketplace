...
$FeatureDir = "C:\Users\Grove\OneDrive\Documents\PYTHON\claude_plugins\vista\.vista\ralph\docker-sandbox-build-d23f7244"
...
Write-Host "Feature:  docker-sandbox-build"
