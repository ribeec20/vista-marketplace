...
PROJECT: vista
JOB: arch-chat-build
JOB_DIR: C:/Users/Grove/OneDrive/Documents/PYTHON/claude_plugins/vista/.vista/ralph/arch-chat-build-5d505475
PLAN_DIR: C:/Users/Grove/OneDrive/Documents/PYTHON/claude_plugins/vista/.vista/ralph/arch-chat-build-5d505475

## Step 0: Understand the Task

Read `C:/Users/Grove/OneDrive/Documents/PYTHON/claude_plugins/vista/.vista/ralph/arch-chat-build-5d505475/task.md` carefully. This file is the single source of truth for what to build.

## Step 1: Read the Implementation Plan

Read `C:/Users/Grove/OneDrive/Documents/PYTHON/claude_plugins/vista/.vista/ralph/arch-chat-build-5d505475/IMPLEMENTATION_PLAN.md` for the detailed implementation plan. Follow it step by step.

If the plan file is not found at that path, search for `IMPLEMENTATION_PLAN.md` in:
1. `.vista/features/arch-chat-build/`
2. `.vista/ralph/arch-chat-build-*/` (most recent match)
...
APPEND to `C:/Users/Grove/OneDrive/Documents/PYTHON/claude_plugins/vista/.vista/ralph/arch-chat-build-5d505475/progress.txt` with a detailed summary:
```
---
Iteration: [number]
Time: [timestamp]
...
Update `C:/Users/Grove/OneDrive/Documents/PYTHON/claude_plugins/vista/.vista/ralph/arch-chat-build-5d505475/IMPLEMENTATION_PLAN.md` to reflect current status:
...
```
git add -A
git commit -m "feat(arch-chat-build): [summary of what was built]"
```
