...
$FeatureDir = "C:\Users\Grove\OneDrive\Documents\PYTHON\claude_plugins\vista\.vista\ralph\architecture-chat-plan-86118b3b"
...
Write-Host "Feature:  architecture-chat-plan"
