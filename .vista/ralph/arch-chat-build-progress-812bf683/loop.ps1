...
param(
    ...
    [string]$Mode = "build",
    [int]$MaxIterations = 3,
    [string]$Model = "github-copilot/gpt-5.2-codex"
)

# Absolute paths baked in by ralph.py - no relative resolution needed
$FeatureDir = "C:\Users\Grove\OneDrive\Documents\PYTHON\claude_plugins\vista\.vista\ralph\arch-chat-build-progress-812bf683"
...
Write-Host "Feature:  arch-chat-build-progress"
Write-Host "Provider: OpenCode"
