...
JOB: share-docs-v2-build
JOB_DIR: C:/Users/Grove/OneDrive/Documents/PYTHON/claude_plugins/vista-expanded-visualization/.vista/ralph/share-docs-v2-build
PLAN_DIR: C:/Users/Grove/OneDrive/Documents/PYTHON/claude_plugins/vista-expanded-visualization/.vista/ralph/share-docs-v2-build

## Step 0: Understand the Task

Read `C:/Users/Grove/OneDrive/Documents/PYTHON/claude_plugins/vista-expanded-visualization/.vista/ralph/share-docs-v2-build/task.md` carefully. This file is the single source of truth for what to build.

## Step 1: Read the Implementation Plan

Read `C:/Users/Grove/OneDrive/Documents/PYTHON/claude_plugins/vista-expanded-visualization/.vista/ralph/share-docs-v2-build/IMPLEMENTATION_PLAN.md` for the detailed implementation plan. Follow it step by step.

If the plan file is not found at that path, search for `IMPLEMENTATION_PLAN.md` in:
1. `.vista/features/share-docs-v2-build/`
2. `.vista/ralph/share-docs-v2-build-*/` (most recent match)
...
APPEND to `C:/Users/Grove/OneDrive/Documents/PYTHON/claude_plugins/vista-expanded-visualization/.vista/ralph/share-docs-v2-build/progress.txt` with a detailed summary:
```
---
Iteration: [number]
Time: [timestamp]
...
Update `C:/Users/Grove/OneDrive/Documents/PYTHON/claude_plugins/vista-expanded-visualization/.vista/ralph/share-docs-v2-build/IMPLEMENTATION_PLAN.md` to reflect current status:
...
```
git add -A
git commit -m "feat(share-docs-v2-build): [summary of what was built]"
```
