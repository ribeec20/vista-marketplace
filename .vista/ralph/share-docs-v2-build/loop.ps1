...
$FeatureDir = "C:\Users\Grove\OneDrive\Documents\PYTHON\claude_plugins\vista-expanded-visualization\.vista\ralph\share-docs-v2-build"
...
Write-Host "Feature:  share-docs-v2-build"
